...
from .api.bihuo_25_video import router as bihuo_25_video_router
...
from .api.native_wechat import router as native_wechat_router
from .api.native_whatsapp import router as native_whatsapp_router
...
from .api.wechat_article import router as wechat_article_router
from .api.wechat_channels_transcript_local import router as wechat_channels_transcript_local_router
...
def _migrate_user_is_overseas_user():
    """Add is_overseas_user for older local SQLite databases."""
    from sqlalchemy import inspect, text
...
def create_app() -> FastAPI:
    ...
    app.include_router(bihuo_25_video_router, prefix="")
    ...
    app.include_router(multi_clip_mixer_router, prefix="")
    app.include_router(media_compat_router, prefix="")
    ...
    app.include_router(native_wechat_router, prefix="")
    app.include_router(native_whatsapp_router, prefix="")
    app.include_router(twilio_whatsapp_router, prefix="")
    app.include_router(youtube_publish_router, prefix="")
    app.include_router(wechat_article_router, prefix="")
    app.include_router(wechat_channels_transcript_local_router, prefix="")
    if wecom_router is not None:
