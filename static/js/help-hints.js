...
(function() {
  var HELP_HINTS = {
    ...
    billing: {
      title: '消费记录',
      html: '<p>展示能力调用与算力扣费流水（以本系统记录为准）。</p><p>「充值」页签可查看充值订单，「消费」为扣费明细。</p>'
    },
    billing_recharge: {
      title: '算力充值',
      html: '<p>选择算力档位后跳转支付。</p><p>完成后余额会更新。若未显示充值区，可能当前版本或环境未开放在线充值。</p>'
    },
    publish_overview: {
      title: '发布中心',
    ...
    billing_pricing_mode: {
      title: '算力',
      html: '<p>下方蓝色区域为服务端下发的算力套餐说明；具体档位以页面展示为准。</p>'
    },
